...
const EventDetails = async ({params:{id},searchParams}:SearchParamProps) => {
  ...
  return (
       ...
       <div className='flex w-full flex-col gap-8 p-5 md:p-10'>
          <div className='flex flex-col gap-6'>
           ...
           <div className='flex  flex-col gap-3 sm:flex-row sm:items-center '>
             <div className='flex gap-3'>
              ...
              <p className='p-medium-16 rounded-full bg-grey-500/100 px-4 py-2.5 text-white'>{event.category.name}</p>
             </div>
          ...
          <div className='flex flex-col gap-5'>
             ...
             <div className='p-regular-20 flex item-center gap-3'>
               ...
               alt='location' width={32} height={32}/>
   ...
   {/**Related Event from the same Organizer*/}
